...
**10/08: Run GWAS to inspect covariates effects**
**10/08: General:**
          - bfile uses new .fam family ids
          - scfc values are located in ABCD_data/Phenotype/


### Using fisher+harm2
  - GWAS with PLINK2.0, using fisher+harm2, with only sex covariates (--glm)
  - fastGWA with GCTA, using fisher+harm2, with only sex covariates
  - GWAS with PLINK1.9, using fisher+harm2, no covariates, using unrelated observations (5628) (--assoc)
  - GWAS with PLINK2.0, using fisher+harm2, no covariates, using unrelated observations (5628) (--glm)
  - GWAS with PLINK2.0, using fisher+harm2, with covariates, using unrelated observations (5628) (--glm)
  - fastGWA with GCTA, using fisher+harm2, no covariates, using unrelated observations (5628)
  - fastGWA with GCTA, using fisher+harm2, with covariates, using unrelated observations (5628)
...
directory <- "/Users/kurt/Documents/Data_Science_Project/1008_GWAS/"
...
# 
```{r}
# Supposedly, only need to run this part once for all subsequent GWAS commands
# ```{r}
