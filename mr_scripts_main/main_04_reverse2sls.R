...
# 4. IV Regression (2-Stage Least Square)
...
pvalthrs <- c(5e-08)                    # thresholds for thresholding               
qc <- "_qc"                             # whether bfile used is QCed
unrel <- "" #"_unrelated"
method <- paste0("dsm5_gwasplink19", qc, unrel)                    # method used
r2 <- 0.001
...
# Combine results from all ROIs and save to local
