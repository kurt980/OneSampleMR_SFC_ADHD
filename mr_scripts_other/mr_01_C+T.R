...
trait_name <- "adhd" ## This is not used here
method <- 'method' ## there was a variable called "method" but never used in the original code
ite <- 1 ## 
...
methods <- c("fastGWA_covsex") # c("gwasplink20_covsex", "")
rois <- (1:379)
