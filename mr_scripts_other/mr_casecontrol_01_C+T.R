...
###################################################################################################################################
## Readme: this code is for running C+T for IV selection. (this is actually identical to main analysis as only the outcome changes)
###################################################################################################################################
...
### Define directories==========================================================
in_dir <- "/Users/grc8mu/Desktop/DS/1102_MR/"
directory <- "/Users/grc8mu/Desktop/DS/1102_MR/"
...
methods <- c("gwasplink19") # c("gwasplink20_covsex", "")
rois <- (1:379)
